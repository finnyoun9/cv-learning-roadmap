...
//端口定义
#define IRQ					RC5				//中断
#define IRQ_T				TRISC5			//中断方向设置
#define nRF24L01_CE			RC3				//使能控制
#define nRF24L01_CE_T		TRISC3			//使能控制方向设置
#define nRF24L01_CSN		RC6				//片选控制
#define nRF24L01_CSN_T		TRISC6			//片选控制方向设置
#define nRF24L01_MISO		RB4				//数据1准备好
#define nRF24L01_MISO_T		TRISB4			//数据1准备好方向设置
#define nRF24L01_SCK		RB6				//时钟输出
#define nRF24L01_SCK_T		TRISB6			//时钟方向控制
#define nRF24L01_MOSI		RC7				//数据输出
#define nRF24L01_MOSI_T		TRISC7			//数据方向设置
